...
| [docs/](docs/) | Справочный материал, который читает сам кит (на английском): 22 режима отказа агентов, генерация изнутри, decision craft, паттерны промптов, как проза о коде расходится с кодом |
