...
Навыки по умолчанию **ручные**: 42 из 49 несут `disable-model-invocation: true` и запускаются, только когда *вы* их набираете. Это осознанно, у этого есть измеренная цена, и есть три обходных пути — [весь размен, с цифрами](guide/ru/evidence.md#manual-skills).
