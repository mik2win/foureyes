...
```python
# Good — the failing name alone says what broke
def test_charge_order_insufficient_funds_raises_payment_error(): ...
def test_parse_config_unknown_key_raises_value_error(): ...
def test_rate_limiter_burst_over_quota_rejects_request(): ...
